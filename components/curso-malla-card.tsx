  ...
  return (
    <Card className={`rounded-md p-0 w-36 h-20 shadow-sm overflow-hidden`}>
      <CardContent className="p-0 flex flex-col justify-start h-full">
        <div className="h-8 bg-zinc-800 flex justify-between p-1">
          <div className="w-5 h-5 bg-white rounded-full font-semibold flex justify-center items-center text-xs">
            {creditos}
          </div>
          <span className="font-semibold text-white text-sm">{codigo}</span>
        </div>

...
- [ ] Manejar estados de carga con skeletons y spinners.
- [ ] Manejar estados de error con páginas amigables (no exponer datos sensibles al cliente).
- [ ] Agregar nombre de la carrera como header en el layout principal.
- [ ] Cambiar tema y colores para parecerse más a páginas de la universidad.
- [x] Manejar estados de confirmación con toasts y modals.
